...
(function ($) {
    ...
    $.fn.columnFilter = function (options) {
        ...
        function fnCreateDropdown(aData) {
            var index = i;
            var r = '<div class="dropdown select_filter form-control"><a class="dropdown-toggle" data-toggle="dropdown" href="#">' + label + '<b class="caret"></b></a><ul  role="menu"><li data-value=""><a>Show All</a></li>', j, iLen = aData.length;
